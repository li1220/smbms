...
<body>
	...
	<ol class="breadcrumb">
		...
		<li><a href="bill_view/${bill.billCode }">查看订单</a></li>
	</ol>
	<div id="dd">
	<form action="" id="contact-form" class="form-horizontal" method="post">
		<fieldset style="color:black">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="form-control" name="nname" value="${bill.productName }" readonly="readonly">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="name">商品单位</label>
				<div class="controls">
					<input type="text" class="form-control" name="unit" value="${bill.productUnit }" readonly="readonly">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="name">商品数量</label>
				<div class="controls">
					<input type="text" class="form-control" name="count" value="${bill.productCount }" readonly="readonly">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="email">总金额</label>
				<div class="controls">
					<input type="text" class="form-control" name="price" value="${bill.totalPrice }" readonly="readonly">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="subject">供应商</label>
				<div class="controls">
				<input value="${bill.proName }" name="pid" class="form-control" readonly="readonly"/>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
 				...
 				<input value="未付款" name="pid" class="form-control" readonly="readonly"/>
				</c:if>
				<c:if test="${bill.isPayment eq 2 }">
				<input value="已付款" name="pid" class="form-control" readonly="readonly"/>
				</c:if>
				</div>
			</div>
