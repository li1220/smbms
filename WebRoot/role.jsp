...
<body>
	...
	<div class="managerList">
		<div class="title">
			<a class="btn btn-success" type="button" href="role_add.jsp">添加</a>
		</div>
		<table
			...
			<tbody>
				<c:forEach items="${rlist }" var="rlist">
			 		<tr>
			 			<td>${rlist.roleCode }</td>
				 		<td>${rlist.roleName }</td>
				 		<td>${rlist.date }</td>
						<td>
							<a class="btn btn-danger btn-sm" href="role_select/${rlist.roleCode }">修改</a>
							<a class="btn btn-info btn-sm" href="role_delect/${rlist.roleCode }">删除</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
