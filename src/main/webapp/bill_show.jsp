	...
	<form action="" id="contact-form" class="form-horizontal" method="post">
		<fieldset style="color:black">
			...
			<div class="control-group">
				...
				<div class="controls">
				<input type="hidden" value="${bill.providerId }" name="pid" class="form-control"/>
			...
			<div class="control-group">
				...
				<input type="radio" name="pay" value="${bill.isPayment }" checked="checked" id="square-radio-1"/>
 				<label for="square-radio-1">未付款</label>
				<input type="radio" name="pay" value="${bill.isPayment }" id="square-radio-2"/>
				<label for="square-radio-2">已付款</label>
				</c:if>
				<c:if test="${bill.isPayment eq 2 }">
				<input type="radio" name="pay" value="${bill.isPayment }" id="square-radio-1"/>
				<label for="square-radio-1">未付款</label>
				<input type="radio" name="pay"checked="checked" value="${bill.isPayment }" id="square-radio-2"/>
				<label for="square-radio-2">已付款</label>
				</c:if>
				</div>
			</div>
