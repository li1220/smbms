...
<body>
	...
	<ol class="breadcrumb">
		...
		<li><a href="gys_add.jsp">添加供应商</a></li>
	</ol>
	<div id="dd">
	<form action="gys_add" id="contact-form" class="form-horizontal" method="post">
		<fieldset style="color:black">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="form-control" name="proContact">
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="form-control" name="proAddress">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="name">传真</label>
				<div class="controls">
					<input type="text" class="form-control" name="proFax" >
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				<label class="control-label" for="name">企业营业执照</label>
				<div class="controls">
					<input type="file" class="form-control" name="zzimg" >
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="name">组织机构代码证</label>
				<div class="controls">
					<input type="file" class="form-control" name="zuzhiimg" >
				</div>
			</div>
