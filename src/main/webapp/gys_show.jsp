...
<body>
	...
	<ol class="breadcrumb">
		...
		<li><a href="gys_show/${pro.proCode }">修改供应商</a></li>
	</ol>
	<div id="dd">
	<form action="gys_update" id="contact-form" class="form-horizontal" method="post">
		<fieldset style="color:black">
			<div class="control-group">
				<label class="control-label" for="name">供应商编码</label>
				<div class="controls">
					<input type="text" class="form-control" name="proCode" value="${pro.proCode }" readonly="readonly">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="name">供应商名称</label>
				<div class="controls">
					<input type="text" class="form-control" name="proName" value="${pro.proName }" >
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="name">联系人</label>
				<div class="controls">
					<input type="text" class="form-control" name="proContact" value="${pro.proContact }">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="name">联系电话</label>
				<div class="controls">
					<input type="text" class="form-control" name="proPhone" value="${pro.proPhone }">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="email">传真</label>
				<div class="controls">
					<input type="text" class="form-control" name="proFax" value="${pro.proFax }">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="subject">描述</label>
				<div class="controls">
				<input value="${pro.proDesc }" name="proDesc" class="form-control"/>
				</div>
			</div>
			<div class="control-group">
