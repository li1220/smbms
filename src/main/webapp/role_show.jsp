...
<body>
	...
	<ul class="parent">
		<ul class="child">
			...
			<li><a href="juese"><span style="color:#cccc00 ">角色管理</span></a></li>
	...
	<ol class="breadcrumb">
		...
		<li><a href="role_select/${list.roleCode }">修改角色</a></li>
	</ol>
	<div id="dd">
	<form action="role_update" id="contact-form" class="form-horizontal" method="post">
		<fieldset style="color:black">
			<div class="control-group">
				<label class="control-label" for="name">用户编号</label>
				<div class="controls">
					<input type="text" class="form-control" name="roleCode" value="${list.roleCode }" readonly="readonly">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="name">用户名称</label>
				<div class="controls">
					<input type="text" class="form-control" name="roleName" value="${list.roleName }">
				</div>
			</div>
			<div class="form-actions" style="margin:20px 0 0 0;">
				<button type="submit" class="btn btn-primary">提交</button>
				<a class="btn btn-success" href="juese">返回</a>
			</div>
		</fieldset>
		</form>
		</div>
