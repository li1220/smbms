...
<body>
	...
	<div id="dd">
	<form action="xgxx" id="contact-form" class="form-horizontal" method="post">
		<fieldset style="color:black">
			<div class="control-group">
				<label class="control-label" for="name">旧密码&nbsp;&nbsp;<span id="sp10"></span></label>
				<div class="controls">
					<input type="password" class="form-control" name="yuanmima">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="name">新密码&nbsp;&nbsp;<span id="sp11"></span></label>
				<div class="controls">
					<input type="password" class="form-control" name="xinmima">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="name">确认新密码&nbsp;&nbsp;<span id="sp12"></span></label>
				<div class="controls">
